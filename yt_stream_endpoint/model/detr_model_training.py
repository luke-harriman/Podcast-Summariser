...
labels = ['Chart' for _ in detections] 
...
TRAIN_DATALOADER = DataLoader(dataset=TRAIN_DATASET, collate_fn=collate_fn, batch_size=10, shuffle=True)
...
# Save Model Weights using PyTorch's method
model_weights_save_path = "./model"
model_instance.model.save_pretrained(model_weights_save_path)

# Save the Image Processor
image_processor_save_path = "./image_processor"
image_processor.save_pretrained(image_processor_save_path)
